...
# Cross-compilation using Milk-V SDK in WSL

set(CMAKE_SYSTEM_NAME Linux)
set(CMAKE_SYSTEM_PROCESSOR riscv64)

# Toolchain path - defaults to WSL location
# Override with: cmake -DTOOLCHAIN_PATH=/path/to/toolchain
if(NOT DEFINED TOOLCHAIN_PATH)
    set(TOOLCHAIN_PATH "$ENV{HOME}/duo-sdk-v1/host-tools/gcc/riscv64-linux-musl-x86_64")
endif()
